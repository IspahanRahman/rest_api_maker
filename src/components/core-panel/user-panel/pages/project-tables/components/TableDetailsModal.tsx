			...
			<div className='max-h-[calc(90vh-120px)] overflow-y-auto pr-2'>
				<div className='space-y-6'>
					...
					<div className='flex items-start justify-between pb-4 border-b border-border-subtle dark:border-border-input'>
						...
						{StatusIcon && (
							<div
								className={`flex items-center gap-1.5 px-3 py-1.5 rounded-full border ${statusConfig?.className}`}
							>
					...
					<div className='bg-primary-50 dark:bg-primary-950/20 border border-primary-200 dark:border-primary-900 rounded-lg p-4'>
						<div className='flex items-center justify-between'>
							<div className='flex-1'>
								<span className='text-sm text-primary-700 dark:text-primary-300 block mb-1'>
									Table Name
								</span>
								<p className='text-base font-mono font-medium text-primary-900 dark:text-primary-200'>
