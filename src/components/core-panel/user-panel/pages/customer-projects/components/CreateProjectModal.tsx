			...
			<form onSubmit={handleSubmit} className='space-y-5'>
				...
				{planOptions.length > 0 && (
					<Select
						...
						onChange={value =>
							setData('package_plan_id', value as string)
						}
						options={planOptions}
				...
				<div className='bg-primary-50 dark:bg-primary-900/20 border border-primary-100 dark:border-primary-800 rounded-lg p-4 flex items-center justify-center gap-2'>
					<p className='text-sm text-primary-700 dark:text-primary-300'>
						A database and API will be automatically generated for
						your project upon creation.
					</p>
				</div>
