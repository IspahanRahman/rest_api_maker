                                ...
                                <div className="flex flex-wrap items-center gap-4 text-xs text-text-secondary dark:text-text-tertiary mb-2">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <button
                                            ...
                                            className="ml-1 p-1 hover:bg-surface-input dark:hover:bg-surface-card rounded-lg transition-colors opacity-0 group-hover:opacity-100"
                    ...
                    <div className="flex items-start gap-2 shrink-0">
                        ...
                        <div className="hidden md:flex items-center gap-1">
                            <button
                                ...
                                disabled={isUpdating}
                                className="p-2 rounded-lg hover:bg-surface-input dark:hover:bg-surface-card transition-colors text-text-secondary dark:text-text-tertiary hover:text-text-primary dark:hover:text-primary-400 disabled:opacity-50 disabled:cursor-not-allowed"
                                title={
                            ...
                            <Link
                                href={`/dashboard/projects/${project.id}`}
                                className="p-2 rounded-lg hover:bg-surface-input dark:hover:bg-surface-card transition-colors text-text-secondary dark:text-text-tertiary hover:text-text-primary dark:hover:text-primary-400"
                                title="View details"
                            >
                            ...
                            {isMenuOpen && (
                                <div className="absolute right-0 mt-2 w-60 bg-surface-card dark:bg-surface-card/95 border border-border-subtle dark:border-border-input rounded-xl shadow-xl z-40 overflow-visible">
                                    ...
                                    <button
                                        ...
                                        className="w-full flex items-center gap-3 px-4 py-3 hover:bg-error-50 dark:hover:bg-error-950/20 text-error-600 dark:text-error-400 transition-colors text-sm text-left"
                                    >
