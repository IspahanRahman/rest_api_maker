				...
				<div className='bg-surface-hover dark:bg-surface-card border border-border-subtle dark:border-border-input rounded-lg p-4'>
					<div className='flex items-center justify-between'>
						<div className='flex items-center gap-2'>
							...
							<span
								className={`text-sm font-semibold capitalize ${getStatusColor(currentStatus)}`}
							>
								{currentStatus}
							</span>
						</div>
						...
						<div className='flex items-center gap-2'>
							...
							<div className='flex items-center gap-1.5'>
								<NewStatusIcon
									className={`w-4 h-4 ${getStatusColor(newStatus)}`}
								/>
								<span
									className={`text-sm font-semibold capitalize ${getStatusColor(newStatus)}`}
								>
									{newStatus}
								</span>
							</div>
